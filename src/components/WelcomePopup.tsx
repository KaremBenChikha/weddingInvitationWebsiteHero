...
export function WelcomePopup({ onDismiss }: WelcomePopupProps) {
  ...
  return (
    <AnimatePresence>
      {visible && (
        <motion.div
          className="fixed inset-0 z-[2147483647] flex items-center justify-center bg-overlay"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          ...
          <motion.div
            className="relative z-10 w-[90vw] max-w-[420px] aspect-[1.15] border border-gold-accent/30 rounded-sm flex flex-col items-center justify-center text-center px-8 py-10 bg-surface/95 backdrop-blur-sm"
          ...
          >
            ...
            <h2 className="font-display text-3xl md:text-4xl text-gold-accent mb-2 tracking-wide">
              {CONTENT.popupTitle}
            </h2>
